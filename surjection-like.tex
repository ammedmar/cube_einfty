We use the following diagrammatic simplification
\begin{center}
...
\begin{center}
	\boxed{\begin{tikzpicture}[scale=.35]		
		...
		\end{tikzpicture}}
\end{center}
and introduce the following terminology: a \textit{surjection-like graph} is either the $(1,0)$-graph \counit\ or for $n > 1$ a $(1, n)$-graph of the form 
\begin{center}
\boxed{\begin{tikzpicture}[scale=.4]
