...
\begin{proof}
	...
	Given the assumptions of the claim and \cref{l:kernel of psi}, the basis elements $x_{< p_x}$ and $y_{< p_y}$ have tensor factors in $\big\{ [0,1], [1] \big\}$, whereas $x_{> p_x}$ and $y_{> p_y}$	have tensor factors in $\big\{ [0], [1] \big\}$.
