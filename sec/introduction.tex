...
The resulting $\UM$-algebra structure on cubical cochains is induced from a natural $\M$-bialgebra structure on the chains of standard cubes, which is determined by only three linear maps.
